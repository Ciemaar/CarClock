...
To help you get started, we have split the documentation into distinct guides:
...
_(Please refer to the [Developer Guide](DEVELOPER_GUIDE.md) for instructions on how to generate and replace these mockups with real device screenshots from your car or emulator)._
...
_(Synthetic mockup of the Analog face with Date enabled)_
...
_(Synthetic mockup of the Digital face with Date enabled)_
...
_(Synthetic mockup of the interactive Settings overlay)_
